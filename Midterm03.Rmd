...
curve(dinvgamma(x,alpha_prior,beta_prior),from=0,to=5,xlab="mu",ylab="",main='Prior')
```
...
curve(dinvgamma(x,alpha_post,beta_post),from=0,to=20,xlab="mu",ylab="",main='Posterior (n=10)')
```
...
curve(dinvgamma(x,alpha_post,beta_post),from=0,to=20,xlab="mu",ylab="",main='Posterior (n=1000)')
```
